    ...
    return (
        <div className="p-8 space-y-8 bg-gray-900 min-h-screen">
            <div className="bg-gradient-to-r from-blue-500 to-indigo-600 p-8 rounded-xl shadow-lg">
                ...
                <p className="text-lg text-gray-300">{findedMovie?.description}</p>
            </div>
                ...
                <div className="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <div className="flex items-center text-yellow-400">
                            ...
                            <span className="text-2xl font-bold">{findedMovie?.rating}</span> / 5
                        </div>
                    </div>
                    <div>
                        <p className="text-xl text-gray-300">Comments:</p>
                        <p className="text-2xl font-semibold text-white">
                            {findedMovie?.comments} comments
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <ul className="space-y-4">
                    {findedMovie?.commentsList.map((comment, index) => (
                        <li
                            key={index}
